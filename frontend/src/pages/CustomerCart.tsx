          ...
          <div className="bg-white p-10 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.3)] max-w-md w-full animate-scale-in border border-white/20">
            ...
            <div className="space-y-5">
              ...
              <button
                ...
                disabled={checkoutLoading}
                className="w-full bg-gray-900 hover:bg-black text-white py-5 rounded-2xl font-black text-xl transition-all shadow-lg transform hover:-translate-y-1 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 tracking-tighter"
              >
                {checkoutLoading ? 'Processing...' : 'Cash on Delivery'}
              </button>
              <button
                onClick={() => setShowCheckout(false)}
                className="w-full bg-gray-50 hover:bg-gray-100 text-gray-600 py-5 rounded-2xl font-bold text-xl transition-all border-2 border-gray-100 mt-4 shadow-sm"
              >
                Cancel
              </button>
            </div>
